...
#DATA_LIST_PATH='./dataset/city/train_aug.txt'
#OUTPUT_ROOT='/home/garbade/models_tf/05_Cityscapes/22_nc19_fullResolution/'
#RESTORE_FROM = './deeplab_tf_model/deeplab_resnet_init.ckpt'
...
def main():
    ...
    if args.restore_from is not None:
        if args.dataset_name == 'VOC2012':
            print('Restoring all but the last layer.')
